...
export const THEMES: Record<'light' | 'dark', Theme> = {
  light: {
    ...
    ray: '#ffffff',
    deep: 'rgba(8,58,76,0.30)',
    vignette: 'rgba(4,44,58,0.22)',
    ...
    fishFilter: `<filter id="fx" filterUnits="userSpaceOnUse" x="-70" y="-70" width="240%" height="240%"><feDropShadow dx="2.5" dy="6" stdDeviation="2.6" flood-color="#063340" flood-opacity="0.3"/></filter>`,
    lily: '#35855c',
